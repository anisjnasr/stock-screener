...
export function getDefaultPrebuiltScreens(): Omit<SavedScreen, "id" | "createdAt">[] {
  ...
  return [
    ...
    },
    {
      ...
      universe: "all",
      type: "script",
      scriptBody: `C > 10 AND MA(V, 20) > 1000000 AND MA(C, 200) > MA(C, 200)[30] AND C > MA(C, 100) AND C > MA(C, 200) AND MA(C, 100) > MA(C, 200) AND MA(C, 50) > MA(C, 100) AND C < MA(C, 50);`,
      filters: {},
    },
    {
      ...
      universe: "all",
      type: "script",
      scriptBody: `ROC(C, 5) >= 100 AND C > 5 AND MA(V, 20) >= 100000;`,
      filters: {},
    },
    {
      ...
      universe: "all",
      type: "script",
      scriptBody: `ROC(C, 1)[1] >= 10 AND C > 15 AND MA(V, 20) > 1000000 AND C > MA(C, 200) AND V[1] / MA(V, 20)[1] >= 2;`,
      filters: {},
    },
    {
      ...
      universe: "all",
      type: "script",
      scriptBody: `ROC(C, 40) >= 100 AND C >= 0.8 * HHV(H, 40) AND C > 15 AND MA(V, 20) > 500000;`,
      filters: {},
    },
  ];
}
