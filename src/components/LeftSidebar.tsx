...
export default function LeftSidebar({
  ...
  return (
    <aside className="w-[22rem] max-w-[22rem] min-w-0 shrink-0 self-stretch min-h-0 border-r border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden flex flex-col">
      <div className="p-2 border-b border-zinc-200 dark:border-zinc-700 shrink-0 min-w-0">
        <h2 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wide mb-1">
          Profile
        </h2>
        {profile?.companyName && (
          ...
          {profile?.website && (
            <p className="text-xs">
              ...
              <a
                ...
                className="text-blue-600 dark:text-blue-400 hover:underline truncate inline"
              >
...
<span className="tabular-nums text-zinc-900 dark:text-zinc-100">
            ...
            <>
              ...
              <span className="text-zinc-900 dark:text-zinc-100">{nextEarnings ? formatDisplayDate(nextEarnings) : "NA"}</span>
            </>
          </div>
        </div>
      </div>
