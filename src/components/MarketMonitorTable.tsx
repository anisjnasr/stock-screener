...
function getPairCellClass(up: number | null | undefined, down: number | null | undefined): string {
  ...
  if (upVal > downVal) return "bg-emerald-100 dark:bg-emerald-300/30 text-zinc-900 dark:text-zinc-100";
  if (downVal > upVal) return "bg-rose-100 dark:bg-rose-300/30 text-zinc-900 dark:text-zinc-100";
  return "";
}
                ...
                <td
                  className={`pl-3 pr-7 py-1.5 border-t border-zinc-100 dark:border-zinc-800 text-right tabular-nums ${
                    row.up4pct > row.down4pct && row.up4pct >= 267
                      ? "bg-emerald-300 dark:bg-emerald-400/60 text-zinc-900"
                ...
                <td
                  className={`pl-3 pr-7 py-1.5 border-t border-zinc-100 dark:border-zinc-800 text-right tabular-nums ${
                    row.down4pct > row.up4pct && row.down4pct >= 233
                      ? "bg-rose-300 dark:bg-rose-400/60 text-zinc-900"
                      : getPairCellClass(row.up4pct, row.down4pct)
                  }`}
                >
                  {fmtInt(row.down4pct)}
