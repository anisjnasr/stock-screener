...
1. **Blueprint:** `stockstalker-python` runs on **Starter (512 MB)** — no disk or DB required.
2. After first deploy, set **`INTERNAL_API_KEY`** on the Python service environment (Render dashboard).
