#!/usr/bin/env node
/**
 * POST /api/cron/macro-writeup (newsletters or web-search fallback → daily_macro_writeup).
 *
 * Loads optional `.env.local` from repo root.
 *
 * Usage:
 *   npm run newsletter:macro:trigger
 *   npm run newsletter:macro:trigger -- --url https://your-app.onrender.com
 */
...
const endpoint = `${rawBase}/api/cron/macro-writeup`;
