...
- [ ] (Optional) Policy / Fed market events: run `data/supabase-market-events.sql`, then [MARKET-EVENTS-PRODUCTION.md](MARKET-EVENTS-PRODUCTION.md) (consolidated workflow **Economic Calendar Ingest**, smoke with `npm run market-events:trigger`).
